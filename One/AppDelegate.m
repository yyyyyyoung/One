...
//    self.window.rootViewController = tabVC;
    ...
    MMDrawerController *mmdVC = [[MMDrawerController alloc] initWithCenterViewController:tabVC rightDrawerViewController:rightVC];
    //设置宽度
    [mmdVC setMaximumRightDrawerWidth:150];
    //设置手势有效区域
//        [mmdVC setOpenDrawerGestureModeMask:MMOpenDrawerGestureModeAll];
    ...
    self.window.rootViewController = mmdVC;
